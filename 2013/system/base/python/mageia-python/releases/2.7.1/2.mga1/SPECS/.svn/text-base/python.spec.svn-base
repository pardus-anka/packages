...
# not very clean patch, should be reworked ( but time is missing
# right now ) 
Patch25:    python_force_semaphore_detection.diff 
...
make test TESTOPTS="-w -l -x test_gdb -x test_site -x test_io -x test_distutils -x test_float"
%else
