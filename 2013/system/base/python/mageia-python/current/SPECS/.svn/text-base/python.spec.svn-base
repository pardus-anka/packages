...
Patch124:	Python-2.7.1-berkeley-db-5.3.patch

Patch126:	Python-2.7.1-berkeley-db-5.3-2.patch

Patch130:	Python-2.7.2-check-for-XML_SetHashSalt.diff

# upstream:
# fix CVE-2011-4944
# http://bugs.python.org/file23824/pypirc-secure.diff
Patch131:   python-2.7.3-upstream-pypirc-secure.patch
